  ...
  const html = `
    <div style="font-family: DM Mono, monospace; background-color: #0f0f0f; padding: 24px; color: #e5e5e5; max-width: 640px; margin: auto; border-radius: 12px;">
      <div style="text-align: center; margin-bottom: 32px;">
        <img src="https://surfrider.io/surfrider-logo.png" alt="surfrider Logo" width="140" style="margin: 0 auto; display: block;" />
      ...
      ${top4.map(signal => `
        <div style="margin-bottom: 36px; padding: 20px; background: #1a1a1a; border-radius: 10px; box-shadow: 0 0 12px #a855f770; border: 1px solid #a855f7;">
          <h2 style="color: #ffffff; font-size: 18px; margin-bottom: 8px;">🔍 ${signal.signal}</h2>
          <p style="color: #bbbbbb; font-size: 14px; margin-bottom: 12px;">${signal.why_it_matters}</p>
          <a href="https://surfrider.io/signal?id=${signal.id}" style="color: #a855f7; font-weight: bold; text-decoration: none;">View Full Signal ↗</a>
        </div>
      `).join('')}
      <div style="border-top: 1px solid #333; padding-top: 24px; text-align: center; font-size: 12px;">
        <p style="color: #999999;">You’re receiving this because you subscribed to Occulta’s radar.</p>
        <p style="color: #999999;"><a href="https://surfrider.io/unsubscribe" style="color: #a855f7; text-decoration: none;">Unsubscribe</a> if you'd like to disable future drops.</p>
        <p style="margin-top: 12px; color: #444;">This transmission was generated by SurfRider AI at ${new Date().toUTCString()}</p>
      </div>
    </div>
  `
